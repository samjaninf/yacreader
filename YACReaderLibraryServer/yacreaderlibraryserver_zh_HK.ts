...
To learn about the available settings please check the documentation at https://raw.githubusercontent.com/YACReader/yacreader/develop/YACReaderLibraryServer/SETTINGS_README.md</source>
        <translation>
YACReaderLibraryServer 是 YACReaderLibrary 的無頭（無 GUI）版本。

此應用程式支援持久性設置，要設定它們，請編輯此文件 %1
若要了解可用設置，請查看文件：https://raw.githubusercontent.com/YACReader/yacreader/develop/YACReaderLibraryServer/SETTINGS_README.md</translation>
    </message>
</context>
</TS>
